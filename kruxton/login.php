...
<style>
	body{
	    ...
	    top:0;
	    left: 0;
	    background-image: url('assets/uploads/espressionist-cover.jpg');
...
<body class="bg-dark">
  ...
  <main id="main" >
  		...
  		<div id="login-center" class="row justify-content-start">
  			<div class="card col-md-3 ml-5" style="box-shadow: 0 4px 6px rgba(0, 0, 0, 0.5); background-color: rgba(255, 255, 255, 0.5);">
  				<div class="card-body py-5 px-1">
  					<h4 class="text-dark text-center mb-5"><!-- ?php echo $_SESSION['system']['name'] ?> -->
  						<img src="assets/uploads/espressionist-rectangle-logo(1).png" width="300px">
  					</h4>
  					<form id="login-form" >
